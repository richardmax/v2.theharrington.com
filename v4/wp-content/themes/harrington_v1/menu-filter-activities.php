<select id="network" class="standard-dropdown sub-filter-dropdown multiselect span12 filter-class-view event" multiple="multiple">
    <option value="june,july,august,september,october,november,december"><a><i class="icon-linkedin icon-border"></i>All Dates</a></option>
    <option value="june"><a><i class="icon-linkedin icon-border"></i>June</a></option>
    <option value="july"><a><i class="icon-linkedin icon-border"></i>July</a></option>
    <option value="august"><a><i class="icon-cloud icon-border"></i>August</a></option>
    <option value="september"><a><i class="icon-cloud icon-border"></i>September</a></option>
    <option value="october"><a><i class="icon-cloud icon-border"></i>October</a></option>
    <option value="november"><a><i class="icon-cloud icon-border"></i>November</a></option>
