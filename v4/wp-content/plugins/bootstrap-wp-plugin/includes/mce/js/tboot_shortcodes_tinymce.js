		...
		render : function(ed, title, id) {
			ed.add({
				...
				onclick: function () {
					...
					//Modal
					if(id == "modal") {
						tinyMCE.activeEditor.selection.setContent('[tboot_modal id="1" header="Title of Modal" color="danger" size="lg" msize="modal-sm" text="Click Here"]Here is he content[/tboot_modal]');
					}
